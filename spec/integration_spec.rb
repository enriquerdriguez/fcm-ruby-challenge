...
RSpec.describe 'Integration Tests' do
  ...
  describe 'with edge case input files' do
    context 'with flight over the next day' do
      it 'handles flight over the next day' do
        processor = ItineraryProcessor.new('SVQ')
        trips = processor.process_file('inputs/input_flight_changing_days.txt')
        expect(trips.length).to eq(3)
    ...
    context 'with wrong segment type' do
    ...
    context 'with wrong IATA code' do
    ...
    context 'with wrong date inside out' do
